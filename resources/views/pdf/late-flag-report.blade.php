      ...
      <table>
        <thead>
          <tr>
            ...
            <th class="desc">Department</th>
            <th class="desc">Total Late</th>
            <th class="desc">Cut Day</th>
        ...
        @foreach($data as $item)
            <tr>
                <td class="desc">{{$item->first_name}}</td>
                <td class="desc">{{$item->company->name}}</td>
                <td class="desc">{{$item->professionaldata->department->name}}</td>
                <td class="desc">{{($item->attendances[0]['late_flag_count'])}}</td>
                <td class="desc">{{floor(($item->attendances[0]['late_flag_count'])/3)}}</td>
            </tr>
        @endforeach
        </tbody>
      </table>
