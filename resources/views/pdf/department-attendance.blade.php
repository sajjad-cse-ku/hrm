  ...
  <header class="clearfix">
      ...
      @if($department)
          <div id="project" class="clearfix">
              ...
              <div>Department Head : {{$department->headed ? $department->headed->first_name : ""}} {{$department->headed ? $department->headed->last_name : ""}}</div>
    ...
    <main>
      <table>
        <thead>
          <tr>
            <th class="desc">Employee</th>
            <th class="desc">Total Days</th>
            <th class="desc">Present</th>
            <th class="desc">Late</th>
              <th class="desc">Absent</th>
            <th class="desc">Off Days</th>
            <th class="desc">Leave</th>
          </tr>
        </thead>
        <tbody>
        @foreach ($data as $item)
                <tr>
                    ...
                    <td class="desc">{{$total_days+1}}</td>
                    <td class="desc">{{$item->present}}</td>
                    <td class="desc">{{$item->total_late_count}}</td>
                    <td class="desc">{{$item->absense}}</td>
                    <td class="desc">{{$item->off_days}}</td>
                    <td class="desc">{{$item->leave}}</td>
                </tr>
        @endforeach
        </tbody>
      </table>
