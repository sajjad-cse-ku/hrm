...
function Index({ result }) {
    ...
    function editData(result) {
        router.get("/admin/leave_category/edit/" + result.id);
    }
    function deleteData(result) {
        router.get("/admin/leave_category/delete/" + result.id);
    }
    function statusChanged(result) {
        router.get("/admin/leave_category/status/" + result.id);
    }
    return (
        <>
            ...
            <div className="panel mt-6">
                ...
                {
                        permissions.includes('leave-category-view') || permissions.includes('super-admin')  ? (
                    <DataTable
...
Index.layout = (page) => (
    <MainLayout children={page} title="HR || Leave Category" />
);
