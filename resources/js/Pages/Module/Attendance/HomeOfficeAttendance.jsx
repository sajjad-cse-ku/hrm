...
function Index() {
    const { base_url, flash , break_times, button} = usePage().props;
        ...
        <>
            ...
            <div className="mb-5 panel mt-6 flex flex-wrap items-center justify-between overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="md:w-1/3 ">
                    <Link href={`${base_url}/admin/home-office-attendance`} className="px-7 py-2 rounded-md btn-gradient  w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] bg-indigo-500 text-white font-bold">
                        {button && button.attend_date !== null
                            ? 'Check Out'
                            : 'Check In'
                        }
                    </Link>
                            ...
                            <ul className=" flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                ...
                                <li className="items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        { isTimerRunning && comment.trim() === '' && (
                                            <span className="text-red-600 text-[14px]">
                                                Please comment then click the stop break
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] bg-indigo-500 text-white">
                                        <button onClick={handleTimerClick} disabled={isTimerRunning && comment.trim() === ''}>
