...
function Index() {
        ...
        if (comment !== "") {
            try {
                ...
                const response = await axios.post(
                    "/admin/home-office-attendance/save",
                    data
                );
    ...
    return (
        <>
            ...
            <div className="mb-5 panel mt-6 pt-5 flex flex-wrap items-center justify-between overflow-x-auto whitespace-nowrap p-3 ">
                <ul className="flex mr-2 mb-3">
                    <li className="text-red-600 hover:underline">
                        <b>
                            <span className="text-[18px]">
                                Check any previous days attendance
                            </span>
                        </b>
                    </li>
                </ul>
                <div className="ml-auto mb-3">
                    <Link
                        href={`${base_url}/admin/home-office-attendance`}
                        className="px-7 py-2 rounded-md btn-primary  w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] bg-indigo-500 text-white font-bold"
                    >
                        Give Attendance
                    </Link>
                </div>
            ...
            <div className="pt-5">
                <div className="flex flex-wrap justify-between items-start mb-5">
                    <div className="panel home-attend">
                        <div className="mb-5">
                            <ul className=" flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                <li className="items-center gap-2">
                                    <div className="rounded-full flex items-center justify-center">
                                        {isTimerRunning && (
                                            <p className="py-1 px-2 bg-danger h-[120px] w-[120px] rounded-full flex items-center justify-center text-white font-bold">
                                    ...
                                    <div
                                        className={`btn ${
                                            isTimerRunning
                                                ? "bg-danger"
                                                : "bg-indigo-500"
                                        } !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] text-white`}
                                    >
                                        <button
