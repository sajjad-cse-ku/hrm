...
function CustomLateAllow() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        router.get("/admin/custom-late-allow-send",values);
    }
    return (
        <>
...
CustomLateAllow.layout = (page) => (
    <MainLayout children={page} title="HR || Custom Late Allow" />
);

export default CustomLateAllow;
