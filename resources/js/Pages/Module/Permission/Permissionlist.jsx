         ...
         <div className="grid xl:grid-cols-1 gap-6 grid-cols-1">
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    {permissionscheck.includes('permission-create') || permissionscheck.includes('super-admin') &&
                        <Link
                ...
                {
                        permissionscheck.includes('permission-view') || permissionscheck.includes('super-admin')  ? (
                    ...
                    <table>
                        ...
                        {permissions.map((data) => {
                            return (
                                <tr key={data.id}>
                                    <td>{data.id}</td>
                                    <td>{data.module?.name || 'N/A'}</td>
                                    <td>{data.permission_name}</td>
                                    <td className="text-center action-btns">
                                        <div className="flex items-center w-max mx-auto gap-2">
                                            {permissionscheck.includes('permission-edit') || permissionscheck.includes('super-admin') &&
                                                <Link
                                            ...
                                            {permissionscheck.includes('permission-delete') || permissionscheck.includes('super-admin') &&
                                                <Link
