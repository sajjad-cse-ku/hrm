...
function EmployeeLeaveApplication() {
    const {  flash,users,errors , permissions } = usePage().props;
    ...
    function handleSubmit(e) {
        e.preventDefault();
        router.get("/admin/emp-leave-report",values);
    }
    return (
        <>
...
EmployeeLeaveApplication.layout = (page) => (
    <MainLayout children={page} title="HR || Emp. Leave Application" />
);
