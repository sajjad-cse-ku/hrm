...
function AssetDetailsEmployeeWise() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        router.get("/admin/asset-details-report-save",values);
    }
    return (
        <>
...
AssetDetailsEmployeeWise.layout = (page) => (
    <MainLayout children={page} title="HR || Asset Report" />
);

export default AssetDetailsEmployeeWise;
