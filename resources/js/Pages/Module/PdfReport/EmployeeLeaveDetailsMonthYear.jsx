                ...
                <div className="panel" id="forms_grid">
                    <div className="flex items-center justify-between mb-5">
                        <h5 className="font-semibold text-lg dark:text-white-light">
                            Month and Year Employee Leave Report
                        </h5>
                    </div>
                    <div className="mb-5">
                        <form
...
AllOrDeptLeaveApplication.layout = (page) => (
    <MainLayout children={page} title="HR || M&Y Epm.Leave Report" />
);

export default AllOrDeptLeaveApplication;
