...
function AllEmployeeAttendanceDateRangeWise() {
...
AllEmployeeAttendanceDateRangeWise.layout = (page) => (
    <MainLayout children={page} title="HR || All Emp. Attendance" />
);

export default AllEmployeeAttendanceDateRangeWise;
