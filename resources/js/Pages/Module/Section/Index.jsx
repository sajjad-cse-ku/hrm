...
function Index() {
    ...
    function statusChanged(result) {
        router.get("/admin/section/status/" + result.id);
    }
    return (
        <>
            ...
            {
                permissions.includes('sub-department-view') || permissions.includes('super-admin') ? (
                    <div className="panel mt-6">
                        <div className="flex md:items-center flex-col sm:flex-row justify-between mb-5 gap-5">
                            ...
                            <div className="flex md:items-center gap-5">
                                ...
                                {
                                    permissions.includes('sub-department-create') || permissions.includes('super-admin') ? (
                                        <Link
                                    ...
                                    },
                                    {
                                        ...
                                        render: (result) => (
                                            <div className="flex items-center w-max mx-auto gap-2">
                                                {
                                                    permissions.includes('sub-department-edit') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/section/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                                            Edit
                                                        </Link>
                                                    ) : null
                                                }
                                                {
                                                    permissions.includes('sub-department-delete') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/section/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                                            Delete
                                                        </Link>
                                                    ) : null
                                                }
