...
function Index({ result }) {
    ...
    function statusChanged(result) {
        router.get("/admin/duty_locations/status/" + result.id);
    }
    return (
        <>
                            ...
                            },
                            {
                                ...
                                render: (result) => (
                                    <div className="flex items-center w-max mx-auto gap-2">
                                        <Link href={`${base_url}/admin/duty_locations/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                            Edit
                                        </Link>

                                        <Link href={`${base_url}/admin/duty_locations/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                            Delete
                                        </Link>
                                    </div>
                                ),
