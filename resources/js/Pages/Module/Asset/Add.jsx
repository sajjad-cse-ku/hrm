...
function Add() {
    const {  flash, asset_type, auth, users   } = usePage().props;
    ...
    function handleSubmit(e) {
        e.preventDefault();
        // console.log(values);
        router.post("/admin/asset/store", values);
        setValues({
            product_name: "",
            asset_type_id:"",
            model:"",
...
Add.layout = (page) => (
    <MainLayout children={page} title="HR || Add Asset" />
);
