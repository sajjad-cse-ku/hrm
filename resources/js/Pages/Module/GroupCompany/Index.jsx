...
function Index() {
    const { base_url ,result,flash,permissions } = usePage().props;
    ...
    return (
        ...
        <FlashMessage flash={flash} />
            ...
            {
                permissions.includes('g-company-view') || permissions.includes('super-admin') ? (
                    <div className="panel mt-6">
                        <div className="flex md:items-center flex-col sm:flex-row justify-between mb-5 gap-5">
                            ...
                            <div className="flex md:items-center gap-5">
                                ...
                                {
                                    permissions.includes('g-company-create') || permissions.includes('super-admin') ? (
                                        <Link
                                            href={`${base_url}/admin/group-companies/create`}
                                            method="get"
                                    ...
                                    },
                                    {
                                        ...
                                        render: (result) => (
                                            <div className="flex items-center w-max mx-auto gap-2">
                                                {
                                                    permissions.includes('g-company-edit') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/group-companies/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                                            Edit
                                                        </Link>
                                                    ) : null
                                                }
                                                ...
                                                {
                                                    permissions.includes('g-company-delete') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/group-companies/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                                            Delete
                                                        </Link>
                                                    ) : null
                                                }
