...
function Index({ result }) {
    ...
    function statusChanged(result) {
        router.get("/admin/project/status/" + result.id);
    }
    return (
        <>
        {
            ...
            <div className="panel mt-6">
                <div className="flex md:items-center flex-col sm:flex-row justify-between mb-5 gap-5">
                    ...
                    <div className="flex md:items-center gap-5">
                        ...
                        <Link
                            href={`${base_url}/admin/project/create`}
                            method="get"
                            ...
                            },
                            {
                                ...
                                render: (result) => (
                                    <div className="flex items-center w-max mx-auto gap-2">
                                        <Link
                                            href={`${base_url}/admin/project/edit/`+result.id}
                                            method="get"
                                            ...
                                            <Link
                                            href={`${base_url}/admin/project/delete/`+result.id}
                                            method="get"
