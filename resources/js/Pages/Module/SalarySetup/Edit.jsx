...
function Edit() {
    const {  flash, companies, users, auth, result, bank   } = usePage().props;
    ...
    const [values, setValues] = useState({
        ...
        others_allowance:result?.others_allowance,
        gross_salary:result?.gross_salary,

        pf_own:result?.pf_own,
        ...
        bank_id:bank?.id,
        account_no:result?.bank_acc_no,
        tds:result?.tds,

        other_deduction:result?.other_deduction,
        other_deduction_details:result?.other_deduction_details,
    ...
    function handleSubmit(e) {
        e.preventDefault();
        // console.log(values);
        router.post("/admin/salary-setups/update", values);
    }
    return (
        <>
