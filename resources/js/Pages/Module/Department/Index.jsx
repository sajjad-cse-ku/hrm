...
function Index({  }) {
    ...
    function editGroupCompany(result) {
        router.get("/admin/department/edit/" + result.id);
    }
    function deleteGroupCompany(result) {
        router.get("/admin/department/delete/" + result.id);
    }
    function statusChanged(result) {
        router.get("/admin/department/status/" + result.id);
    }
    return (
        <>
                            ...
                            <div className="flex md:items-center gap-5">
                                ...
                                </div>
                                {
                                    permissions.includes('department-create') || permissions.includes('super-admin') ? (
                                        <Link
                                            href={`${base_url}/admin/department/create`}
                                            method="get"
                                            ...
                                            <div className="flex items-center w-max mx-auto gap-2">
                                                {
                                                    permissions.includes('department-edit') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/department/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                                            Edit
                                                        </Link>
                                                    ) : null
                                                }
                                                {
                                                    permissions.includes('department-delete') || permissions.includes('super-admin') ? (
                                                        <Link href={`${base_url}/admin/department/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                                            Delete
                                                        </Link>
                                                    ) : null
                                                }
