...
function Index() {
    ...
    useEffect(() => {
        setInitialRecords2(() => {
            return result.filter((item) => {
                return (
                    item.posting_start_date.toLowerCase().includes(search2.toLowerCase())
                );
            });
        });
    }, [search2]);
    ...
    function statusChanged(result) {
        router.get("/admin/employee_posting/status/" + result.id);
    }
    return (
        <>
                                    ...
                                    <div className="datatables">
                                        <DataTable
                                            ...
                                            columns={[
                                                ...
                                                {
                                                    accessor: "posting_start_date",
                                                    title: "Posting Start Date",
                                                    render: ({ posting_start_date }) => (
                                                        <div className="flex items-center w-max">
                                                            <div>{posting_start_date}</div>
                                                        </div>
                                                    ),
                                                },
                                                {
                                                ...
                                                },
                                                {
                                                    ...
                                                    render: (result) => (
                                                        <div className="flex items-center w-max mx-auto gap-2">
                                                            {
                                                                permissions.includes('emp-posting-edit') || permissions.includes('super-admin') ? (
                                                                    <Link href={`${base_url}/admin/employee_posting/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                                                        Edit
                                                                    </Link>
                                                                ) : null
                                                            }
                                                            {
                                                                permissions.includes('emp-posting-delete') || permissions.includes('super-admin') ? (
                                                                    <Link href={`${base_url}/admin/employee_posting/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                                                        Delete
                                                                    </Link>
                                                                ) : null
                                                            }
