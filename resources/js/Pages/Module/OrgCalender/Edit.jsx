...
function Edit() {
    ...
    const [values, setValues] = useState({
        id: result.id,
        calender_year:result?.calender_year,
        month_id:result?.month_id,
        c_month_id:result?.c_month_id,
        start_from:result?.start_from,
        ends_on:result?.ends_on,
        salary_open:result?.salary_open,
        salary_update:result?.salary_update,
        food_open:result?.food_open,
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        id="salary_update"
                                        className="form-select text-white-dark"
                                        defaultValue={values.salary_update ?? 'F'}
                                        onChange={handleChange}
                                    >
                                        <option value="F">Future</option>
                                        <option value="O">Open</option>
                                ...
                                <div>
                                    ...
                                    <select
                                        id="food_open"
                                        className="form-select text-white-dark"
                                        defaultValue={values.food_open ?? 'F'}
                                        onChange={handleChange}
                                    >
                                        <option value="F">Future</option>
                                        <option value="O">Open</option>
...
Edit.layout = (page) => (
    <MainLayout children={page} title="HR || Edit Org Calender" />
);
