...
function Index() {
    ...
    function statusChanged(result) {
        router.get("/admin/asset-type/status/" + result.id);
    }
                    ...
                    <div className="panel mt-6">
                        <div className="flex md:items-center flex-col sm:flex-row justify-between mb-5 gap-5">
                            ...
                            <div className="flex md:items-center gap-5">
                                ...
                                {/*    permissions.includes('super-admin') ? (*/}
                                        <Link
                                            href={`${base_url}/admin/asset-type/create`}
                                            method="get"
                            ...
                            <DataTable
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        render: ({ asset_type }) => (
                                            <div className="flex items-center w-max">
                                                <div>{asset_type == "P" ? "Physical" : "Virtual"}</div>
                                            </div>
                                        ),
                                    },
                                    {
                                        ...
                                        render: (result) => (
                                            <div className="flex items-center w-max mx-auto gap-2">
                                                ...
                                                {/*    permissions.includes('salary-setups-edit') || permissions.includes('super-admin') ? (*/}
                                                        <Link href={`${base_url}/admin/asset-type/edit/`+result.id} method="get" className="btn btn-sm btn-outline-primary">
                                                            Edit
                                                        </Link>
                                                {/*    ) : null*/}
                                                {/*}*/}
                                                ...
                                                {/*    permissions.includes('salary-setups-delete') || permissions.includes('super-admin') ? (*/}
                                                        <Link href={`${base_url}/admin/asset-type/delete/`+result.id} method="get" className="btn btn-sm btn-outline-danger">
                                                            Delete
                                                        </Link>
                                                {/*    ) : null*/}
                                                {/*}*/}
...
Index.layout = (page) => (
    <MainLayout children={page} title="HR || Asset Type List" />
);
