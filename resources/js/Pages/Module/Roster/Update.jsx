...
function Index() {
    ...
    const individualUserData = (userId) => {
        const userToSubmit = rosters.find((user) => user.id === userId);
            ...
            <FlashMessage flash={flash} />
            {
                roster_status === false ?
                    ...
                    <>
                        ...
                        {
                            permissions.includes('roster-update') || permissions.includes('super-admin')  ? (
                                                                                        ...
                                                                                        <tr key={idx}>
                                                                                                ...
                                                                                                <td key={dayOfWeek}>
                                                                                                    <div>
                                                                                                        <select
                                                                                                            ...
                                                                                                            {...register(`[${roster.user.id}].roster[${dayOfWeek}-${weeks[weekNumber][dayOfWeek]}]`)}
                                                                                                            value={
                                                                                            ...
                                                                                            <td>
                                                                                                <div>
                                                                                                    <select
                                                                                                        className="form-select text-white-dark"
                                                                                                        {...register(`[${roster.user.id}].location[weak-${weekNumber}]`)}
...
Index.layout = (page) => (
    <MainLayout children={page} title="HR || Roster Update" />
);
