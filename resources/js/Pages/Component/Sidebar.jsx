        ...
        <div className="bg-white dark:bg-black h-full">
            <div className="flex justify-between items-center px-4 py-3">
                <Link href="/" className="main-logo flex items-center shrink-0">
                    ...
                    <span className="text-xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('LUMINOUS HRM')}</span>
                </Link>
                <button
                    type="button"
                    ...
                    <li className="nav-item">
                        <ul>
                                ...
                                <Link href={`${base_url}/admin/dashboard`} className="group">
                                    <div className="flex items-center">
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.5013 1.66699H3.33464C2.41416 1.66699 1.66797 2.41318 1.66797 3.33366V9.16699C1.66797 10.0875 2.41416 10.8337 3.33464 10.8337H7.5013C8.42178 10.8337 9.16797 10.0875 9.16797 9.16699V3.33366C9.16797 2.41318 8.42178 1.66699 7.5013 1.66699Z" fill="#888EA8"/>
                                            <path d="M16.6654 1.66699H12.4987C11.5782 1.66699 10.832 2.41318 10.832 3.33366V5.83366C10.832 6.75413 11.5782 7.50033 12.4987 7.50033H16.6654C17.5858 7.50033 18.332 6.75413 18.332 5.83366V3.33366C18.332 2.41318 17.5858 1.66699 16.6654 1.66699Z" fill="#888EA8"/>
                                            <path d="M7.5013 12.5H3.33464C2.41416 12.5 1.66797 13.2462 1.66797 14.1667V16.6667C1.66797 17.5871 2.41416 18.3333 3.33464 18.3333H7.5013C8.42178 18.3333 9.16797 17.5871 9.16797 16.6667V14.1667C9.16797 13.2462 8.42178 12.5 7.5013 12.5Z" fill="#888EA8"/>
                                            <path d="M16.6654 9.16699H12.4987C11.5782 9.16699 10.832 9.91318 10.832 10.8337V16.667C10.832 17.5875 11.5782 18.3337 12.4987 18.3337H16.6654C17.5858 18.3337 18.332 17.5875 18.332 16.667V10.8337C18.332 9.91318 17.5858 9.16699 16.6654 9.16699Z" fill="#888EA8"/>
                                        </svg>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'task_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/project`}>{t('Project')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/task/assign-task`}>{t('Assign Task')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/task/my-task`}>{t('My Task')}</Link>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'manage_company' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('manage_company')}>
                                    <div className="flex items-center">
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16 13H14V15H16M16 9H14V11H16M18 17H10V15H12V13H10V11H12V9H10V7H18M8 5H6V3H8M8 9H6V7H8M8 13H6V11H8M8 17H6V15H8M4 5H2V3H4M4 9H2V7H4M4 13H2V11H4M4 17H2V15H4M10 5V1H0V19H20V5H10Z" fill="#888EA8"/>
                                        </svg>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'configuration' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link className={url === `${base_url}/admin/org_calender`? 'active' : ''} href={`${base_url}/admin/org_calender`}>{t('Org Calender')}</Link>
                                        </li>

                                        <li>
                                            <Link className={url === `${base_url}/admin/site-settings`? 'active' : ''} href={`${base_url}/admin/site-settings`}>{t('Site Settings')}</Link>
                                        </li>
                                        {/*<li>*/}
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'departments' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('departments')}>
                                    <div className="flex items-center">

                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18.2805 13.3934H16.4703V10.3034C16.47 10.115 16.3974 9.93444 16.2685 9.80147C16.1398 9.66854 15.9652 9.59409 15.7834 9.59443H10.2022V6.55043H11.8672C11.9971 6.55043 12.1216 6.49689 12.2134 6.4018C12.3053 6.3067 12.3568 6.17757 12.3568 6.04308V1.78131C12.3562 1.5017 12.1371 1.27539 11.8672 1.27539H7.75376C7.48377 1.27607 7.26529 1.5031 7.26529 1.78271V6.04436C7.26609 6.32413 7.48508 6.55043 7.755 6.55043H9.41873V9.59583H3.83748C3.45987 9.59655 3.1539 9.91356 3.15324 10.3048V13.4085H1.7994C1.53244 13.4094 1.31641 13.638 1.31641 13.9198V18.2127C1.31641 18.495 1.53336 18.724 1.8007 18.724H5.86898C6.13602 18.7232 6.35205 18.4945 6.35205 18.2127V13.9185C6.35129 13.6366 6.13468 13.4085 5.86776 13.4085H3.93667V10.4062H9.41873V13.4502H7.755C7.62519 13.4502 7.50055 13.5037 7.40876 13.5989C7.31696 13.694 7.26529 13.823 7.26529 13.9576V18.218C7.26529 18.3525 7.31698 18.4815 7.40876 18.5767C7.50055 18.6718 7.62519 18.7253 7.755 18.7253H11.8672C11.9971 18.7253 12.1216 18.6718 12.2134 18.5767C12.3053 18.4815 12.3568 18.3525 12.3568 18.218V13.9562C12.3562 13.6766 12.1371 13.4502 11.8672 13.4502V13.4488H10.2022V10.4048H15.6868V13.3934H14.2009C13.877 13.3934 13.715 13.563 13.715 13.9049V18.2125C13.715 18.5544 13.8757 18.7253 14.1996 18.7253H18.2805C18.6044 18.7253 18.7663 18.5544 18.7663 18.2125V13.9062C18.7663 13.5644 18.6044 13.3934 18.2805 13.3934Z" fill="#888EA8"/>
                                        </svg>

                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Manage Department')}</span>
                                    </div>

                                    <div className={currentMenu === 'departments' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'departments' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link className={url === `${base_url}/admin/section`? 'active' : ''} href={`${base_url}/admin/section`}>{t('Sub Department (Section)')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'manage_employee' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('manage_employee')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Manage Employee')}</span>
                                    </div>

                                    <div className={currentMenu === 'manage_employee' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'manage_employee' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/employee`} method='get'>{t('Manage Employee')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'leave_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/leave_category`} method='get'>{t('Leave Category')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/leave_application`} method='get'>{t('Leave Application')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/leave_application/leave-acknowledge`} method='get'>{t('Leave Acknowledge')}</Link>
                                        </li>
                                        <li>
                                            <Link className={url === `${base_url}/admin/leave_application/leave-report-to`? 'active' : ''} href={`${base_url}/admin/leave_application/leave-report-to`}>{t('Leave Recommend')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/leave_application/requested-user`} method='get'>{t('Leave Approval')}</Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link className={url === `${base_url}/admin/leave_application/direct-leave-approve`? 'active' : ''} href={`${base_url}/admin/leave_application/direct-leave-approve`}>{t('Leave approved by HR')}</Link>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'shift_management' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('shift_management')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Shift Management')}</span>
                                    </div>

                                    <div className={currentMenu === 'shift_management' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </button>
                                <AnimateHeight duration={300} height={currentMenu === 'shift_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/shift`} method='get'>{t('Manage Shift')}</Link>
                                        </li>
                                        <li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'late_management' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('late_management')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Late Management')}</span>
                                    </div>

                                    <div className={currentMenu === 'late_management' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </button>
                                <AnimateHeight duration={300} height={currentMenu === 'late_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/apply-list`} method='get'>{t('Apply List')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/late-apply`} method='get'>{t('Late Apply')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/late-list`} method='get'>{t('Late list')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/custom-late-allow`} method='get'>{t('Custom Late Allow ')}</Link>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'roster_management' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('roster_management')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Roster Management')}</span>
                                    </div>

                                    <div className={currentMenu === 'roster_management' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </button>
                                <AnimateHeight duration={300} height={currentMenu === 'roster_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/roster`} method='get'>{t('Roster Entry')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/roster/update`} method='get'>{t('Roster Update')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/roster/approved`} method='get'>{t('Approved Roster')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link to="/users/user-account-settings">{t('Account Settings')}</Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link href="/admin/permissions">{t('Permissions')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/modules`}>{t('Modules')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'report_management' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('report_management')}>
                                    <div className="flex items-center">

                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.04175 18.7503H1.54175V15.8328L4.04175 13.8215V18.7503ZM8.938 12.8128L7.6705 11.3353L6.438 12.3365V18.7503H8.938V12.8128ZM13.833 11.829L11.333 14.1603V18.7503H13.833V11.829ZM18.7292 7.42152L16.2292 9.78527V18.7503H18.7292V7.42152ZM18.4167 5.00027C18.638 4.73527 18.6017 4.34152 18.338 4.12027C18.073 3.90027 17.6805 3.93527 17.458 4.19902L10.8955 10.4328L7.64925 7.24402L1.5005 12.3003C1.22425 12.5078 1.168 12.899 1.37425 13.174C1.583 13.4503 1.973 13.5065 2.24925 13.3015L7.60675 8.91402L10.9155 12.189L18.4167 5.00027ZM19.7142 6.31527L19.7155 2.85777C19.7142 2.67527 19.6505 2.52402 19.5305 2.40152C19.4055 2.27902 19.2555 2.21902 19.0767 2.21777L15.6167 2.21902C15.4355 2.21777 15.2842 2.28152 15.1617 2.40152C15.038 2.52527 14.9755 2.67527 14.9742 2.85902C14.9755 3.04027 15.038 3.19027 15.1592 3.31277L18.618 6.77027C18.743 6.89527 18.893 6.95652 19.0717 6.95652C19.2542 6.95527 19.408 6.89402 19.528 6.77027C19.6505 6.64777 19.7142 6.49777 19.7142 6.31527Z" fill="#888EA8"/>
                                        </svg>

                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Report Management')}</span>
                                    </div>

                                    <div className={currentMenu === 'report_management' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </button>
                                <AnimateHeight duration={300} height={currentMenu === 'report_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/employee-attendance/date-range-wise`} method='get'>{t('Emp. Attendance')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/department-attendance/date-range-wise`} method='get'>{t('Dept. Attendance')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/all-emp-attendance/date-range-wise`} method='get'>{t('All Emp. Attendance')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/punch-details/date-range-wise`} method='get'>{t('Punch Details Attendance')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/late-flag-report`} method='get'>{t('Late Flag Report')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/all-type-employee`} method='get'>{t('Employee Report')}</Link>
                                        </li>

                                        <li>
                                            <Link href={`${base_url}/admin/emp-leave`} method='get'>{t('Emp.Leave Report')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/all-or-dept-leave`} method='get'>{t('Dept.Leave Report')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/employee-leave-details-month-year`} method='get'>{t('M&Y Epm.Leave Report')}</Link>
                                        </li>
                            ...
                            <li className="nav-item">
                                <Link href={`${base_url}/admin/get-date-wise-attendance`} className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Get Attendance')}</span>
                                    </div>
                                </Link>
                            </li>
                        </ul>
